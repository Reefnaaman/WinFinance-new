    ...
    Tables: {
      ...
      whatsapp_conversations: {
        Row: {
          ...
          lead_id: string
          phone: string
          status: 'queued' | 'template_sent' | 'active' | 'meeting_scheduled' | 'not_interested' | 'no_reply' | 'needs_human' | 'opted_out' | 'error'
...
export type WhatsAppConversationStatus = 'queued' | 'template_sent' | 'active' | 'meeting_scheduled' | 'not_interested' | 'no_reply' | 'needs_human' | 'opted_out' | 'error'